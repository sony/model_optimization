...
* <ins>Clustering:</ins> Using non-uniform quantization grid to quantize the weights and activations to match their distributions using look-up-tables for quantizing to clusters centroids.
