...
.. code-block:: python
   ...
   snop.set_logger_folder('/logger/dir/path')
...
As for now, snop uses cosine-similarity to compare the tensors along the models and display its changes within the
TensorBoard UI.
