...
Models for IMX500, TFLite and qnnpack can be observed `here <https://github.com/sony/model_optimization/tree/main/model_compression_toolkit/tpc_models>`_, and can be used using :ref:`get_target_platform_capabilities function<ug-get_target_platform_capabilities>`.
...
.. literalinclude:: ../../../../../model_compression_toolkit/tpc_models/default_tpc/v3/tp_model.py
    :language: python
    :lines: 15-156
...
.. literalinclude:: ../../../../../model_compression_toolkit/tpc_models/default_tpc/v3/tpc_keras.py
    :language: python
    :lines: 15-86
