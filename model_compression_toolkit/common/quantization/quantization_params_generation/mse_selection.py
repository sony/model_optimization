...
def mse_selection_tensor(tensor_data: np.ndarray,
    ...
    return {THRESHOLD: qparams_selection_tensor_search(lambda x, y, threshold: compute_mse(x, y),
                                                       tensor_data,
                                                       n_bits,
...
def mse_selection_histogram(bins: np.ndarray,
    ...
    """
    return {THRESHOLD: qparams_selection_histogram_search(_mse_error_histogram,
                                                          bins,
                                                          counts,
                                                          n_bits,
