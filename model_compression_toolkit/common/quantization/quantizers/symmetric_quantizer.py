...
# TODO: method is identical to "power_of_teo_quantizer" since there is no relevance to the 'power_of_two'
#  property here, after the threshold already been computed
#  Consider removing power_of_two and use only symmetric quantizer for both
