...
from model_compression_toolkit.common.target_platform.current_target_platform_model import _current_target_platform_model, \
    get_current_target_platform_model
...
def get_default_quantization_config_options() -> QuantizationConfigOptions:
    ...
    """
    return get_current_target_platform_model().default_qco
...
def get_default_quantization_config():
    ...
    return get_current_target_platform_model().get_default_op_quantization_config()
...
class TargetPlatformModel(ImmutableClass):
    ...
    def get_default_op_quantization_config(self) -> OpQuantizationConfig:
        ...
        assert len(self.default_qco.quantization_config_list) == 1, \
            ...
            f' but found {len(get_current_target_platform_model().default_qco.quantization_config_list)} configurations.'
    ...
    def __enter__(self):
        ...
        """
        _current_target_platform_model.set(self)
        return self
    ...
    def __exit__(self, exc_type, exc_value, tb):
        ...
        _current_target_platform_model.reset()
