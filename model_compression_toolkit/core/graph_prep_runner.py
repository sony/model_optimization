...
from model_compression_toolkit.core.load_fqc import load_fqc_configuration
...
def get_finalized_graph(initial_graph: Graph,
    ...
    # TODO irena: extracted from set_quantization_configuration_to_graph. Put somewhere.
    ...
    for n in transformed_graph.nodes:
        ...
        for qc in [*n.tpc_quantization_info.candidates_quantization_cfg, n.tpc_quantization_info.base_quantization_cfg]:
