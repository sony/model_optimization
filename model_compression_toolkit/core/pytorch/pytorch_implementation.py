...
from model_compression_toolkit.core.pytorch.graph_substitutions.substitutions.linear_input_reshape import \
    LinearInputReshape
...
class PytorchImplementation(FrameworkImplementation):
    ...
    def run_model_inference(self,
        ...
        """
        if isinstance(input_list, dict) and "input_ids" in input_list:
