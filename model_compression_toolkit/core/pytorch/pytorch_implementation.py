...
class PytorchImplementation(FrameworkImplementation):
    ...
    def model_grad(self,
        ...
        """
        Calls a PyTorch specific model gradient calculation function, which computes the jacobian of the model's
        ...
        Returns: A list of normalized jacobian traces to be considered as the relevancy that each interest
