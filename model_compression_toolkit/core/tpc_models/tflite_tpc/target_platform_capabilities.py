...
if FOUND_TF:
    ...
    from model_compression_toolkit.core.tpc_models.tflite_tpc.latest import get_keras_tpc as get_keras_tpc_latest
...
if FOUND_TORCH:
    ...
    from model_compression_toolkit.core.tpc_models.tflite_tpc.latest import \
