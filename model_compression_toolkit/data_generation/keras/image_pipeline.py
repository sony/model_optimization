...
image_normalization_dict: Dict[ImageNormalizationType, List[List[float]]] = {
    ...
    ImageNormalizationType.MOBILENET: [(127.5, 127.5, 127.5), (127.5, 127.5, 127.5)],
    ImageNormalizationType.EFFICIENTNET: [[123.675, 116.28, 103.53], [58.395, 57.12, 57.375]],
    ImageNormalizationType.RESNET50: [[103.939, 116.779, 123.68], [1.0, 1.0, 1.0]],
