...
def get_random_gaussian_data(
    ...
    Args:
        ...
        image_size (Tuple[int, int]): Size of each image as (height, width).
    ...
    Returns:
        Tuple[int, iter]: A tuple containing the number of batches and a data loader iterator.
    """
    ...
    num_batches = np.floor_divide(n_images, batch_size).astype(int)
    return num_batches, data_loader
