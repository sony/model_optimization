...
class ReduceLROnPlateauWithReset(tf.keras.callbacks.Callback):
    """
    ...
    def __init__(self, optimizer: tf.keras.optimizers.Optimizer, mode: str = 'min', factor: float = 0.1,
        ...
        Args:
            ...
            verbose (bool): If True, prints a message to stdout for each update. Default: False.
        """
        super(ReduceLROnPlateauWithReset, self).__init__()
    ...
    def on_epoch_end(self, epoch: int, loss: float = None, logs: dict = None) -> None:
        """
        Check conditions and update learning rate at the end of an epoch.
        ...
        if current is None:
            raise ValueError('ReduceLROnPlateauWithReset requires loss value')
    ...
    def get_config(self) -> Dict:
        ...
        base_config = super(ReduceLROnPlateauWithReset, self).get_config()
