...
def get_inferable_quantizer_kwargs(node: BaseNode,
                                   quantization_target: qi.QuantizationTarget) -> Dict[str, Any]:
    """
    ...
    if quantization_target == qi.QuantizationTarget.Weights:
    ...
    elif quantization_target == qi.QuantizationTarget.Activation:
...
def get_weights_quantizer_for_node(node: BaseNode) -> pytorch_inferable_quantizers.BasePyTorchInferableQuantizer:
    ...
    kwargs = get_inferable_quantizer_kwargs(node, qi.QuantizationTarget.Weights)
...
def get_activations_quantizer_for_node(node: BaseNode) -> pytorch_inferable_quantizers.BasePyTorchInferableQuantizer:
    ...
    kwargs = get_inferable_quantizer_kwargs(node, qi.QuantizationTarget.Activation)
