...
from model_compression_toolkit.common.substitutions.residual_collapsing import ResidualCollapsing
from model_compression_toolkit.keras.constants import KERNEL, LINEAR, ACTIVATION, LAYER_NAME
