...
if importlib.util.find_spec("tensorflow") is not None \
    ...
    # If tensorflow/tensorflow-model-optimization is not installed,
    # we raise an exception when trying to use these functions.
    def keras_post_training_quantization(*args, **kwargs):
        Logger.critical('Installing tensorflow and tensorflow_model_optimization is mandatory when using keras_post_training_quantization. '
                        'Could not find at least one of them.')

    def keras_post_training_quantization_mixed_precision(*args, **kwargs):
        Logger.critical('Installing tensorflow and tensorflow_model_optimization is mandatory when using keras_post_training_quantization_mixed_precision. '
                        'Could not find at least one of them.')
