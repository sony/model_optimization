...
from model_compression_toolkit.keras_framework.constants import SOFTMAX, LINEAR, RELU, SWISH, SIGMOID, IDENTITY, TANH, SELU, \
    KERNEL, DEPTHWISE_KERNEL
from model_compression_toolkit.keras_framework.quantizer.fake_quant_builder import constraint_quantization
"""
