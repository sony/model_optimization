...
from model_compression_toolkit.keras_framework.constants import KERNEL, BIAS, LINEAR, ACTIVATION, RELU_MAX_VALUE
from model_compression_toolkit.keras_framework.constants import RELU
