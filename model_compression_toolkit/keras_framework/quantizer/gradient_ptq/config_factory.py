...
from model_compression_toolkit import keras_framework
from model_compression_toolkit.common.constants import THRESHOLD
from model_compression_toolkit.keras_framework.constants import DEPTHWISE_KERNEL, KERNEL
...
def quantization_config_builder_gptq(n: common.Node,
    ...
    if n.activation_quantization() and n.weight_quantization():
        qc = keras_framework.quantizer.gradient_ptq.ActivationAndWeightQuantizeConfig(fw_info.get_kernel_op_attributes(n.layer_class),
        ...
        qc = keras_framework.quantizer.gradient_ptq.ActivationQuantizeConfig(n.activation_quantization_cfg.activation_quantization_params,
                                                                             n.activation_quantization_cfg.activation_is_signed,
                                                                             num_bits=n.activation_quantization_cfg.activation_n_bits)
    elif n.weight_quantization():
        qc = keras_framework.quantizer.gradient_ptq.WeightQuantizeConfig(fw_info.get_kernel_op_attributes(n.layer_class),
                                                                         n.final_weights_quantization_cfg.weights_quantization_params.get(THRESHOLD),
                                                                         n.final_weights_quantization_cfg.weights_channels_axis,
                                                                         n.final_weights_quantization_cfg.weights_n_bits,
                                                                         max_lsbs_change=MAX_LSBS_CHANGE
