...
if importlib.util.find_spec("torch") is not None:
    ...
    def pytorch_kpi_data(in_model: Module,
        ...
        Args:
            ...
            fw_hw_model (FrameworkHardwareModel): FrameworkHardwareModel to optimize the Keras model according to. . `Default Keras info <https://github.com/sony/model_optimization/blob/9513796726e72ebdb5b075f5014eb8feae47f3ae/model_compression_toolkit/hardware_models/pytorch_hardware_model/pytorch_default.py#L33>`_
