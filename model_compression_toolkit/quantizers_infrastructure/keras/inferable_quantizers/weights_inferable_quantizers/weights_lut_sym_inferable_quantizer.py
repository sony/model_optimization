...
if FOUND_TF:
    ...
    from model_compression_toolkit.quantizers_infrastructure.keras.inferable_quantizers \
        .base_lut_sym_inferable_quantizer import BaseLutSymInferableQuantizer


    class WeightsLutSymInferableQuantizer(BaseLutSymInferableQuantizer):
        """
        Class for quantizing weights using a lut sym quantizer
        """
        ...
        def __init__(self,
            ...
            """
            super(WeightsLutSymInferableQuantizer, self).__init__(num_bits,
                                                                  cluster_centers,
                                                                  threshold,
                                                                  signed,
        ...
        def get_config(self):
            ...
            Returns:
                Dictionary with the following keys: 'num_bits', 'cluster_centers', 'threshold',
                'signed'
            """
