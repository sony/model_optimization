...
from model_compression_toolkit.target_platform_capabilities.default_tpc.v4_lut import __version__ as TPC_VERSION
...
from model_compression_toolkit.target_platform_capabilities.default_tpc.v4_lut.tp_model import get_tp_model
