...
from model_compression_toolkit.target_platform_capabilities.default_tpc.target_platform_capabilities import \
    tpc_dict as default_tpc_dict
from model_compression_toolkit.target_platform_capabilities.imx500_tpc.target_platform_capabilities import \
    tpc_dict as imx500_tpc_dict
from model_compression_toolkit.target_platform_capabilities.tflite_tpc.target_platform_capabilities import \
    tpc_dict as tflite_tpc_dict
from model_compression_toolkit.target_platform_capabilities.qnnpack_tpc.target_platform_capabilities import \
