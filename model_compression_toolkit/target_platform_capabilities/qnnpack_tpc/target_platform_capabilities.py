...
if FOUND_TF:
    from model_compression_toolkit.target_platform_capabilities.qnnpack_tpc.v1.tpc_keras import get_keras_tpc as get_keras_tpc_v1
    from model_compression_toolkit.target_platform_capabilities.qnnpack_tpc.latest import get_keras_tpc_latest
...
if FOUND_TORCH:
    from model_compression_toolkit.target_platform_capabilities.qnnpack_tpc.v1.tpc_pytorch import \
        get_pytorch_tpc as get_pytorch_tpc_v1
    from model_compression_toolkit.target_platform_capabilities.qnnpack_tpc.latest import get_pytorch_tpc_latest
