...
if FOUND_TF:
    ...
    from model_compression_toolkit.target_platform_capabilities.tpc_models.imx500_tpc.v2_pot.tpc_keras import get_keras_tpc as get_keras_tpc_v2_pot
...
if FOUND_TORCH:
    ...
    from model_compression_toolkit.target_platform_capabilities.tpc_models.imx500_tpc.v2_pot.tpc_pytorch import \
        get_pytorch_tpc as get_pytorch_tpc_v2_pot
