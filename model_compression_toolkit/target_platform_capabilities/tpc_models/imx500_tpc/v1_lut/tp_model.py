...
def get_op_quantization_configs() -> Tuple[OpQuantizationConfig, List[OpQuantizationConfig]]:
    ...
    four_bits_lut = eight_bits.clone_and_edit(attr_weights_configs_mapping={KERNEL_ATTR:
    ...
    two_bits_lut = eight_bits.clone_and_edit(attr_weights_configs_mapping={KERNEL_ATTR:
        kernel_base_config.clone_and_edit(
            weights_n_bits=2,
            weights_quantization_method=
            tp.QuantizationMethod.LUT_SYM_QUANTIZER),
