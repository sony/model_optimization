...
from model_compression_toolkit.target_platform_models.tflite import get_tflite_target_platform_model


def get_keras_tflite_tpc():
    tp_model = get_tflite_target_platform_model()
    tflite_keras = TargetPlatformCapabilities(tp_model, name='tflite_keras')
