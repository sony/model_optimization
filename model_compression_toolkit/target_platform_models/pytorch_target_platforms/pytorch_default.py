...
def get_default_tpc_pytorch():
    default_tp_model = get_default_target_platform_model()
    return generate_tpc_model_pytorch(name='default_tp_model_pytorch',
                                      tp_model=default_tp_model)


def generate_tpc_model_pytorch(name: str, tp_model: TargetPlatformModel):
    """
    ...
    Returns: TargetPlatformCapabilities object for the given TargetPlatformModel.

    """

    tpc_pytorch = TargetPlatformCapabilities(tp_model,
                                              name=name)
