...
from model_compression_toolkit.common.target_platform.targetplatform2framework import TargetPlatformCapabilities, OperationsSetToLayers
from model_compression_toolkit.target_platform_models.qnnpack import get_qnnpack_model


def get_qnnpack_pytorch():
    tp_qnnpack = get_qnnpack_model()
    qnnpack_pytorch = TargetPlatformCapabilities(tp_qnnpack,
