...
# ==============================================================================
from model_compression_toolkit.target_platform_models.default_target_platform import get_op_quantization_configs, generate_target_platform_model
...
def generate_test_tp_model(edit_params_dict, name=""):
    ...
    return generate_target_platform_model(default_config=updated_config,
...
def generate_mixed_precision_test_tp_model(base_cfg, mp_bitwidth_candidates_list, name=""):
    ...
    return generate_target_platform_model(default_config=base_cfg,
