...
def generate_tp_model(default_config: OpQuantizationConfig,
    ...
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_STACK, qc_options=no_quantization_config))
    ...
    div = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_DIV)
