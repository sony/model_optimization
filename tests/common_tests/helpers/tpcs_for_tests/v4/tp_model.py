...
def generate_tp_model(default_config: OpQuantizationConfig,
    ...
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SIZE, qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_EQUAL, qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_ARGMAX, qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_TOPK, qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_COMBINED_NON_MAX_SUPPRESSION,qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_FAKE_QUANT,qc_options=no_quantization_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SSD_POST_PROCESS, qc_options=no_quantization_config))

    quant_preserving_config = (default_configuration_options.clone_and_edit(enable_activation_quantization=False,
                                                                            quantization_preserving=True)
                               .clone_and_edit_weight_attribute(enable_weights_quantization=False))

    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_UNSTACK, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_DROPOUT, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SPLIT_CHUNK, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_GET_ITEM, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_MAXPOOL, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_PAD, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_ZERO_PADDING2d, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_CAST, qc_options=quant_preserving_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_STRIDED_SLICE, qc_options=quant_preserving_config))
    ...
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_FLATTEN, qc_options=dim_manipulation_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_RESHAPE, qc_options=dim_manipulation_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_UNSQUEEZE, qc_options=dim_manipulation_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SQUEEZE, qc_options=dim_manipulation_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_PERMUTE, qc_options=dim_manipulation_config))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_TRANSPOSE, qc_options=dim_manipulation_config))

    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_GATHER, qc_options=qpreserving_const_config_options))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_EXPAND, qc_options=qpreserving_const_config_options))

    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_STACK, qc_options=const_configuration_options_inout16_per_tensor))
    ...
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_BATCH_NORM, qc_options=default_config_options_16bit))
    operator_set.append(schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_MIN, qc_options=default_config_options_16bit))
    ...
    conv_transpose = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_CONV_TRANSPOSE, qc_options=mixed_precision_configuration_options)
    depthwise_conv = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_DEPTHWISE_CONV, qc_options=mixed_precision_configuration_options)
    ...
    relu = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_RELU, qc_options=default_config_options_16bit)
    ...
    prelu = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_PRELU, qc_options=default_config_options_16bit)
    add = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_ADD, qc_options=const_configuration_options_inout16)
    sub = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SUB, qc_options=const_configuration_options_inout16)
    mul = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_MUL, qc_options=const_configuration_options_inout16)
    div = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_DIV, qc_options=const_configuration_options)
    swish = schema.OperatorsSet(name=schema.OperatorSetNames.OPSET_SWISH, qc_options=default_config_options_16bit)
