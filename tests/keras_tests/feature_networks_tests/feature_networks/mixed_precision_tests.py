...
from tests.keras_tests.target_platform_capabilities_keras import generate_activation_mp_tpc_keras
...
class MixedPrecisionActivationBaseTest(BaseKerasFeatureNetworkTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        tp_model = generate_tp_model_with_activation_mp(eight_bits,
                                                   mixed_precision_candidates_list,
                                                   name='mp_default_tp_model')

        return generate_activation_mp_tpc_keras(name="mixed_precision_activation_test", tp_model=tp_model)
...
class MixedPrecisionActivationSearchKPI4BitsAvgTest(MixedPrecisionActivationBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        tp_model = generate_tp_model_with_activation_mp(eight_bits, mixed_precision_candidates_list, name='mp_default_tp_model')
        return generate_activation_mp_tpc_keras(name="mixed_precision_4bit_test", tp_model=tp_model)
...
class MixedPrecisionActivationDepthwise4BitTest(MixedPrecisionActivationBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        tp_model = generate_tp_model_with_activation_mp(eight_bits, mixed_precision_candidates_list, name='mp_default_tp_model')
        return generate_activation_mp_tpc_keras(name="mixed_precision_depthwise_4bit_test", tp_model=tp_model)
...
class MixedPrecisionActivationOnlyTest(MixedPrecisionActivationBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        tp_model = generate_tp_model_with_activation_mp(eight_bits, mixed_precision_candidates_list, name='mp_default_tp_model')
        return generate_activation_mp_tpc_keras(name="mixed_precision_activation_weights_disabled_test", tp_model=tp_model)
...
class MixedPrecisionActivationOnlyWeightsDisabledTest(MixedPrecisionActivationBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        tp_model = generate_tp_model_with_activation_mp(weights_disabled_config, mixed_precision_candidates_list, name='mp_default_tp_model')
        return generate_activation_mp_tpc_keras(name="mixed_precision_activation_weights_disabled_test", tp_model=tp_model)
