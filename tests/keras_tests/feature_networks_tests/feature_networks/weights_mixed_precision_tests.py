...
class MixedPercisionManuallyConfiguredTest(MixedPercisionBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        return generate_tpc_for_keras(name="mp_test", tp_model=mp_tp_model)
    ...
    def get_target_platform_capabilities(self):
        ...
        mp_tp_model = generate_mixed_precision_test_tp_model(base_cfg=base_config,
                                                             mp_bitwidth_candidates_list=[(8, 16), (2, 16), (4, 16),
                                                                                          (16, 16)])
        return generate_tpc_for_keras(name="mp_dw_test", tp_model=mp_tp_model)
...
class MixedPrecisionActivationDisabled(MixedPercisionBaseTest):
    ...
    def get_target_platform_capabilities(self):
        ...
        return generate_tpc_for_keras(name="mp_weights_only_test", tp_model=mp_tp_model)
