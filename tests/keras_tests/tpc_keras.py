...
def get_weights_only_mp_tpc_keras(base_config, default_config, mp_bitwidth_candidates_list, const_config, name):
...
def get_tpc_with_activation_mp_keras(base_config, default_config, mp_bitwidth_candidates_list, const_config, name):
