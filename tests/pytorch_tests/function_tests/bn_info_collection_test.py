...
class BNInfoCollectionTest(BasePytorchTest):
    ...
    def run_test(self):
        ...
        self.unit_test.assertTrue((gamma.data.cpu().numpy() == prior_std).all())
        self.unit_test.assertTrue((beta.data.cpu().numpy() == prior_mean).all())
...
class Conv2D2BNInfoCollectionTest(BasePytorchTest):
    ...
    def run_test(self):
        ...
        m_std = np.sqrt(mv.data.cpu().numpy())
        self.unit_test.assertTrue((mm.data.cpu().numpy() == conv_mean).all())
        self.unit_test.assertTrue((m_std == conv_std).all())

        gamma = bn_layer.weight
        beta = bn_layer.bias
        self.unit_test.assertTrue((beta.data.cpu().numpy() == bn_mean).all())
        self.unit_test.assertTrue((gamma.data.cpu().numpy() == bn_std).all())

        bn2_layer = model_float.bn2
        gamma2 = bn2_layer.weight
        beta2 = bn2_layer.bias
        self.unit_test.assertTrue((beta2.data.cpu().numpy() == bn2_mean).all())
        self.unit_test.assertTrue((gamma2.data.cpu().numpy() == bn2_std).all())
...
class BNChainInfoCollectionTest(BasePytorchTest):
    ...
    def run_test(self):
        ...
        mv = bn_layer.running_var
        m_std = np.sqrt(mv.data.cpu().numpy())
        self.unit_test.assertTrue((mm.data.cpu().numpy() == prior_mean).all())
...
class BNLayerInfoCollectionTest(BasePytorchTest):
    ...
    def run_test(self):
        ...
        m_std2 = np.sqrt(mv2.data.cpu().numpy())
        self.unit_test.assertTrue((mm2.data.cpu().numpy() == relu_mean).all())
        ...
        m_std3 = np.sqrt(mv3.data.cpu().numpy())
        self.unit_test.assertTrue((mm3.data.cpu().numpy() == add_mean).all())
        self.unit_test.assertTrue((m_std3 == add_std).all())

        gamma3 = bn3_layer.weight
        beta3 = bn3_layer.bias
        self.unit_test.assertTrue((beta3.data.cpu().numpy() == bn3_mean).all())
        self.unit_test.assertTrue((gamma3.data.cpu().numpy() == bn3_std).all())
