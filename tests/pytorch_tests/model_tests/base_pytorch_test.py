...
class BasePytorchTest(BaseFeatureNetworkTest):
    ...
    def get_quantization_configs(self):
        return {
            'no_quantization': mct.QuantizationConfig(mct.ThresholdSelectionMethod.NOCLIPPING,
            ...
            'all_32bit': mct.QuantizationConfig(mct.ThresholdSelectionMethod.NOCLIPPING,
                                                mct.ThresholdSelectionMethod.NOCLIPPING,
                                                mct.QuantizationMethod.POWER_OF_TWO,
                                                mct.QuantizationMethod.POWER_OF_TWO,
                                                32, 32, False, True, True,
