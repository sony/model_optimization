...
class BasePytorchTest(BaseFeatureNetworkTest):
    ...
    def get_target_platform_capabilities(self):
        return {
            'no_quantization': generate_tpc_model_pytorch(name="no_quant_pytorch_test",
                                                          tp_model=generate_test_tp_model({'weights_n_bits': 32,
                                                                                                 'activation_n_bits': 32,
                                                                                                 'enable_weights_quantization': False,
                                                                                                 'enable_activation_quantization': False
                                                                                           })),
            'all_32bit': generate_tpc_model_pytorch(name="32_quant_pytorch_test",
                                                    tp_model=generate_test_tp_model({'weights_n_bits': 32,
                                                                                           'activation_n_bits': 32,
                                                                                           'enable_weights_quantization': True,
                                                                                           'enable_activation_quantization': True
                                                                                     })),
            'all_4bit': generate_tpc_model_pytorch(name="4_quant_pytorch_test",
    ...
    def run_test(self, seed=0):
        ...
        for model_name in quant_config_dict.keys():
            ...
            tpc = self.get_target_platform_capabilities()[model_name]
