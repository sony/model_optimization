...
from model_compression_toolkit.tpc_models.default_tpc.v4.tp_model import generate_tp_model
...
from model_compression_toolkit.tpc_models.default_tpc.latest import get_tp_model, generate_pytorch_tpc, get_op_quantization_configs
