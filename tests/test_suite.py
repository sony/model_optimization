...
if found_pytorch:
    from tests.pytorch_tests.function_tests.test_device_manager import TestIsValidDevice
...
if __name__ == '__main__':
    ...
    if found_pytorch:
        suiteList.append(unittest.TestLoader().loadTestsFromTestCase(TestIsValidDevice))
