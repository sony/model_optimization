...
from tests.common_tests.test_target_platform_model import TPModelTest, OpsetTest, QCOptionsTest, FusingTest
...
if found_pytorch:
    ...
    from tests.pytorch_tests.test_pytorch_target_platform_models import TestPytorchTPModel
...
if __name__ == '__main__':
    ...
    suiteList.append(unittest.TestLoader().loadTestsFromTestCase(TPModelTest))
