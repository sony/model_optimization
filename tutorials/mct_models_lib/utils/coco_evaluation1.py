...
def scale_boxes(boxes, H, W, h_image, w_image, preserve_aspect_ratio):
    """
...
def format_results(outputs, img_ids, orig_img_dims):
    ...
    for idx, output in enumerate(outputs):
        ...
        boxes = scale_boxes(boxes*640, 640, 640, orig_img_dims[idx][0], orig_img_dims[idx][1], preserve_aspect_ratio=True)
