...
if __name__ == '__main__':
    ...
    target_platform_cap = mct.get_target_platform_capabilities('tensorflow', 'default', 'v1_lut')
    ...
    kpi_data = mct.core.keras_resource_utilization_data(model, representative_data_gen, configuration,
