...
Please note that during the first model evaluation, Ultralytics downloads the COCO dataset to the folder specified in their 'coco.yaml' file. Therefore, the 'validation_dataset_folder' value is not required in this case.
...
For more information on the dataset format please refere to [ultralytics docs](https://docs.ultralytics.com/datasets/)
